...
public class LexiconTest {
	...
	// for some reason I was getting an error saying lx was null
	// so I just ran the setup function manually before each test
	@BeforeEach
	public void setup() {
		lx = new LexiconTrie();
	}
	...
	public void testRemoveComplicated() {
		...
		// removing a word that is the prefix of another shouldn't break those longer
		// words
		// or anything else
		Assertions.assertTrue(lx.removeWord("cat"));
		Assertions.assertEquals(3, lx.numWords());
