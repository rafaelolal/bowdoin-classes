...
class WorldMap {
     ...
     */
    static void drawCreature(Creature creature) {
        if (map == null) {
     ...
     */
    private static void clearSquare(Position pos) {
        if (map == null) {
            throw new IllegalStateException(
                    "map not created; call WorldMap.initialize");
        }
     ...
     *                 The position of the square to clear.
     */
    static void drawMovedCreature(Creature creature, Position prevPos) {
        if (map == null) {
            throw new IllegalStateException(
     ...
     */
    static void pause(long durationMs) {
        try {
